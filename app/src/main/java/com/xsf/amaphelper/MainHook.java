...
public class MainHook implements IXposedHookLoadPackage {
    ...
    private void registerReceiver(Context context, String procName) {
        try {
                ...
                public void onReceive(Context ctx, Intent intent) {
                    try {
                        ...
                        if (AMAP_ACTION.equals(action)) {
                            ...
                            if (b != null) {
                                ...
                                if (procName.equals("Widget")) {
                                    if (Math.random() < logSamplingRate) { // 核心修改：使用变量而非写死
                        ...
                        // 🔥 接收采样率更新指令
                            ...
                            XposedBridge.log("NaviHook: [" + procName + "] 采样率已更新为: " + logSamplingRate);
                        }
            ...
            filter.addAction("XSF_ACTION_SET_SAMPLE_RATE"); // 注册新 Action
